...
Collection of POCs for static and dynamic load balancing, and running multiple Docker containers in a single Docker image.

- static_haproxy: a static proxy example using HAProxy.
